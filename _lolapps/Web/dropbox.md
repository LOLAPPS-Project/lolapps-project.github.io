...
Usage:
  - Category: Data Exfiltration
    Steps to replicate: Create a free dropbox account. Upload files that you want to exfiltrate. 
    ...
    MitreID: T1567.002
  - Category: Download
    Steps to replicate: Create a free dropbox account. Upload a password protected archive. Access Dropbox from the victim host and download/extract the archive.
